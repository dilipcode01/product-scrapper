...
import { Search, Filter, Package, Eye, Download, RefreshCw, X } from "lucide-react"
...
const Products = () => {
  ...
  const getSourceSiteColor = (sourceSite) => {
    switch (sourceSite) {
      case "walmart":
      ...
      <div className="card p-4">
        ...
        {hasActiveFilters && (
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            {searchTerm && (
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                ...
                <button
                  ...
                  className="ml-1 h-3 w-3 hover:bg-blue-200 rounded-full"
                >
                  <X className="h-2 w-2" />
                </button>
              </span>
            ...
            {filters.category && (
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                ...
                <button
                  ...
                  className="ml-1 h-3 w-3 hover:bg-gray-200 rounded-full"
                >
                  <X className="h-2 w-2" />
                </button>
              </span>
            ...
            {filters.sourceSite && (
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                Site: {filters.sourceSite}
                <button
                  onClick={() => handleFilterChange("sourceSite", "")}
                  className="ml-1 h-3 w-3 hover:bg-gray-200 rounded-full"
                >
                  <X className="h-2 w-2" />
                </button>
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                {hasActiveFilters 
                  ...
                  : "Get started by scraping some products."
                }
              </p>
              {hasActiveFilters && (
                <button
                ...
                <div key={product._id} className="card overflow-hidden">
                  ...
                  <div className="p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getSourceSiteColor(product.sourceSite)}`}>
                        {product.sourceSite}
                      </span>
                    </div>
